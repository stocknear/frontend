...
<section class="w-full max-w-4xl overflow-hidden m-auto min-h-screen pt-5 pb-40">
    ...
    <div class="bg-[#0F0F0F] sm:mt-10 sm:rounded-xl border-t sm:border hover:border-slate-700 border-slate-800 pb-10">
        ...
        {#if !data?.user}
        <a class="w-96 mt-6 m-auto flex m-auto justify-center items-center m-auto btn text-white bg-blue-700 hover:bg-blue-600 transition duration-150 ease-in-out group" href="/register">
            Get Newsletter
        ...
        <form method="POST" class="flex flex-col items-center space-y-2 w-5/6 sm:pt-8 ml-auto mr-auto">
            ...
            <div class="w-full sm:w-5/6 max-w-lg m-auto pb-5">
                <button type="submit" class="py-3 bg-blue-700 text-white hover:bg-blue-600 w-full rounded-lg m-auto font-bold text-md">
                    Subscribe
                </button>
            </div>
        </form>
