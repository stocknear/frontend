<script lang="ts">
  ...
  $: rememberSavedFilter(
    SAVED_FILTER_COOKIE.coveredCallScreener,
    selectedStrategy,
  );
  let groupedRules = {};
  let displayRules = [];
        ...
        <div class="flex w-full sm:w-[50%] sm:ml-3 md:block md:w-auto ml-3">
          ...
          <div class="relative inline-block text-left grow">
            <DropdownMenu.Root>
              ...
              <DropdownMenu.Content
                class="w-fit max-w-56 h-fit max-h-72 overflow-y-auto scroller rounded-container border border-line bg-surface-card p-1.5 text-fg shadow-none"
              >
                <DropdownMenu.Label
                  class="text-fg font-normal"
                >
