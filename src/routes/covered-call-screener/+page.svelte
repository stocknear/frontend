        ...
        <div class="flex w-full sm:w-[50%] sm:ml-3 md:block md:w-auto ml-3">
          ...
          <div class="relative inline-block text-left grow">
            <DropdownMenu.Root>
              ...
              <DropdownMenu.Content
                class="w-fit max-w-56 h-fit max-h-72 overflow-y-auto scroller rounded-2xl border border-gray-300 dark:border-zinc-700 bg-white/95 dark:bg-zinc-950/95 p-1.5 text-muted dark:text-zinc-200 shadow-none"
              >
                <DropdownMenu.Label
                  class="text-muted dark:text-white font-normal"
                >
