...
<section class="overflow-y-auto mb-10 text-fg">
  <div
    ...
    <div class="w-full m-auto min-h-screen">
      <!--
        <div class="text-sm sm:text-[1rem] breadcrumbs mb-5">
          <ul>
            <li><a href="/" class="text-fg-muted hover:text-accent transition">Home</a></li>
            <li class="text-muted dark:text-fg-muted">Options Flow</li>
          </ul>
        </div>
        -->
      <div class="sm:rounded-control">
        ...
        >
          <div
            class="flex flex-col sm:flex-row items-center pt-3 sm:pt-1 pb-3 sm:border-b sm:border-line"
          >
            <div
            ...
            >
              ...
              >
                <div
                  class="rounded-full w-10 h-10 relative border border-line bg-surface-page/60 text-fg flex items-center justify-center"
                >
                  {#if !muted}
                    <svg
                      class="w-4 h-4"
              ...
              <span
                class="text-xs sm:text-sm sm:text-lg text-fg mr-3"
              >
              ...
              <div class="relative flex flex-col sm:flex-row items-center">
                <Popover.Root>
                  <Popover.Trigger asChild let:builder>
                    <Button
                      class="w-full sm:w-[160px] truncate py-2.5 border border-line bg-surface-page/60 text-fg justify-center sm:justify-start text-center sm:text-left rounded-full font-medium hover:text-accent transition"
                      builders={[builder]}
                    >
                      <CalendarIcon
          ...
          >
            <button
              ...
              class="flex cursor-pointer items-center text-base sm:text-lg font-semibold text-fg"
              title={showFilters
                ? options_flow_hide_filter_area()
                : options_flow_show_filter_area()}
            >
          ...
          {#if showFilters}
            ...
            >
              <label
                for="ruleModal"
                class="text-sm inline-flex cursor-pointer items-center justify-center space-x-1 whitespace-nowrap rounded-full border border-line/90 dark:border-white/80 py-2 pl-3 pr-4 font-semibold bg-gray-900 text-white dark:bg-white dark:text-gray-900 transition hover:bg-gray-800 dark:hover:bg-zinc-200 focus:outline-hidden"
              >
                <svg
                  class="h-5 w-5"
                  viewBox="0 0 20 20"
              ...
              {#if data?.user}
                <label
                  ...
                  class="text-sm sm:ml-3 cursor-pointer inline-flex items-center justify-center space-x-1 whitespace-nowrap rounded-full border border-line/90 dark:border-white/80 bg-gray-900 text-white dark:bg-white dark:text-gray-900 py-2 pl-3 pr-4 font-semibold transition hover:bg-gray-800 dark:hover:bg-zinc-200 focus:outline-hidden"
                >
                  <svg
                ...
                {#if strategyList?.length > 0}
                  <label
                    ...
                    class="text-sm sm:ml-3 cursor-pointer inline-flex items-center justify-center space-x-1 whitespace-nowrap rounded-full border border-line bg-surface-page/60 text-fg py-2 pl-3 pr-4 font-semibold transition hover:text-accent focus:outline-hidden"
                  >
            ...
            >
                                  ...
                                  >
                                    ...
                                    {#if ruleCondition[row?.rule] === "between"}
                                      ...
                                      >
                                        <input
                                          ...
                                          class="ios-zoom-fix block max-w-[3.5rem] rounded-full placeholder:text-muted dark:placeholder:text-zinc-300 font-normal p-1 text-sm bg-surface-page/60 border border-line"
                                        />
                                        <span
                                    ...
                                    {:else}
                                      <input
                                        ...
                                        class="ios-zoom-fix block max-w-[4.8rem] rounded-full placeholder:text-muted dark:placeholder:text-zinc-300 font-normal p-1 text-sm bg-surface-page/60 border border-line"
                                      />
                                    {/if}
                                      ...
                                      {#if newValue && row?.step[index + 1]}
                                        ...
                                        >
                                          <button
                                            ...
                                            class="block w-full cursor-pointer border-b border-line px-4 py-1.5 text-left text-sm rounded-control last:border-0 focus:outline-hidden"
                                          >
              ...
              {#if trackedContracts?.size > 0}
                ...
                >
                  <span
                    class="text-xs font-semibold text-fg uppercase tracking-wide mr-1"
                  >
                  ...
                  {:else}
                    <button
                      ...
                      class="cursor-pointer inline-flex items-center gap-1 rounded-full bg-surface-raised/60 text-fg-muted text-xs font-medium px-2 py-1 hover:bg-gray-200 dark:hover:bg-zinc-700/50 transition"
        ...
        {#if isLoaded}
          <div class="w-full mt-5 m-auto flex justify-center items-center">
            <div class="w-full grid grid-cols-1 lg:grid-cols-4 gap-y-3 gap-x-3">
              ...
              <div
                class="flex flex-col w-full px-5 py-3 bg-surface-card border border-line rounded-container h-20"
              >
                <div class="flex flex-col items-start justify-between mb-2">
                  {#if data?.user?.tier === "Pro"}
                    ...
                    >
                      <div class="flex items-center gap-1">
                        ...
                        ></span>
                        <span class="text-fg">Bullish</span>
                        <span
                          class="font-semibold text-up"
                      ...
                      <div class="flex items-center gap-1">
                        ...
                        ></span>
                        <span class="text-fg">Bearish</span>
                        <span
                          class="font-semibold text-down"
                  ...
                  {:else}
                    <div class="flex flex-col items-start">
                      <span class="text-xs text-fg mt-1.5"
                        >Flow Sentiment</span
                      >
                      {#if data?.user?.tier === "Pro"}
              ...
              <!--Start Put/Call-->
              <div
                class="flex flex-row items-center w-full px-5 py-3 bg-surface-card border border-line rounded-container h-20"
              >
                <div class="flex flex-col items-start">
                ...
                <div class="relative size-14 ml-auto">
                  ...
                  >
                    ...
                    <circle
                      ...
                      r="16"
                      fill="none"
                      class="stroke-current text-fg-muted dark:text-[#3E3E3E]"
                      stroke-width="3"
                    ></circle>
              ...
              >
                <div class="flex flex-col items-start">
                  <div class="flex flex-row items-center gap-2">
                    ...
                    {#if data?.user?.tier === "Pro"}
                      <span
                        class="text-sm font-semibold text-up"
                      >
              ...
              >
                <div class="flex flex-col items-start">
                  <div class="flex flex-row items-center gap-2">
                    ...
                    {#if data?.user?.tier === "Pro"}
                      <span
                        class="text-sm font-semibold text-down"
                      >
                  ...
                  >
                    ...
                    <g class="origin-center -rotate-90 transform">
                      <circle
                        ...
                        r="16"
                        fill="none"
                        class="stroke-current text-down"
                        stroke-width="3"
                        stroke-dasharray="100"
                        stroke-dashoffset={data?.user?.tier === "Pro"
        ...
        >
          ...
          <div class="relative w-full max-w-sm">
            ...
            <input
              autocomplete="off"
              id="search"
              class="focus:outline-none placeholder-gray-500 dark:placeholder:text-zinc-400 block w-full p-2 ps-10 text-sm text-fg border border-line rounded-full bg-surface-page/60"
