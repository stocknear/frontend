        ...
        <main class="w-full lg:pr-5">
          ...
          <div class="items-center lg:overflow-visible px-1 py-1 mt-4">
            ...
            >
              ...
              >
                <div
                  class="relative lg:ml-auto w-full lg:w-fit rounded-full border border-gray-300 shadow dark:border-zinc-700 bg-white/80 dark:bg-zinc-950/60 overflow-hidden"
                >
                  <div
