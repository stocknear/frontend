<script lang="ts">
  ...
  import {
    ...
    analysts_flow_count,
    analysts_flow_empty,
    analysts_flow_infobox,
    analysts_flow_main_name,
    analysts_flow_seo_description,
    analysts_flow_seo_keywords,
    analysts_flow_seo_title,
...
<SEO
  title={analysts_flow_seo_title()}
  description={analysts_flow_seo_description()}
  keywords={analysts_flow_seo_keywords()}
  structuredData={{
        ...
        <main class="w-full lg:pr-5">
          <div class="border-b border-line">
            <div class=" flex flex-row items-center gap-3">
              <h1
                class="mb-3 text-2xl sm:text-3xl font-semibold tracking-tight text-fg"
              >
                {analysts_flow_main_name()}
              </h1>
              <div class="ml-auto">
          ...
          <div class="w-full m-auto mt-4">
                      ...
                      >
                        {#each columns as column}
                          ...
                          {:else if column.key === "analystName"}
                            ...
                            <td
                              class="text-[0.85rem] sm:text-sm text-start whitespace-nowrap align-middle"
                            >
                              <FollowAnalystButton
                                variant="row"
                          ...
                          {:else if column.key === "name"}
                            <td
                              class="text-[0.85rem] sm:text-sm text-start whitespace-nowrap text-fg-muted"
                            >
            ...
            {:else}
              <Infobox text={analysts_flow_empty({ query: inputValue })} />
            {/if}
