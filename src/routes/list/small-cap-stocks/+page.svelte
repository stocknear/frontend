<script lang='ts'>
  ...
  let rawData = data?.getSmallCapStocks;
  ...
  <section class="w-full max-w-4xl overflow-hidden m-auto">
    ...
    <div class="w-full max-w-4xl m-auto text-gray-100 font-medium bg-[#202020] sm:rounded-lg h-auto p-5 mb-4">
      ...
      <a href="/list/micro-cap-stocks" class="text-blue-400 hover:text-white">
          Micro-Cap
      </a>,
