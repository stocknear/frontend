...
<section class="w-full overflow-hidden m-auto">
  ...
  <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden mt-5">
    ...
    >
      <main class="w-full">
        <div
          class="w-full flex flex-col sm:flex-row items-center justify-start sm:justify-between text-fg sm:pt-2 sm:pb-2 sm:border-t sm:border-b sm:border-gray-300 sm:dark:border-zinc-700"
        >
          <div
          ...
          <div
            class="flex items-center ml-auto border-t border-b border-line sm:border-none pt-2 pb-2 sm:pt-0 sm:pb-0 w-full"
          >
                  ...
                  {#each displayList as item}
                    ...
                    >
                      {#each columns as column}
                        {#if column.key === "rank"}
                          <td
                            class="text-start text-[0.85rem] sm:text-sm text-fg-muted whitespace-nowrap"
                          >
                            {item?.rank}
                          </td>
