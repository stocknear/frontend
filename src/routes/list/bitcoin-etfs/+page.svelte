<script lang="ts">
  ...
  import {
    common_home,
    list_bitcoin_etfs_empty,
    list_bitcoin_etfs_infobox,
    list_bitcoin_etfs_main_description,
    list_bitcoin_etfs_main_name,
    list_bitcoin_etfs_seo_description,
    list_bitcoin_etfs_seo_keywords,
    list_bitcoin_etfs_seo_title,
    list_bitcoin_etfs_structured_description,
  ...
  const sortData = (key) => {
    ...
    if (sortOrder === "none") {
      if (inputValue?.length > 0) {
        ...
        originalData = data?.getETFBitcoinList || [];
        rawData = [...originalData];
        currentPage = 1; // Reset to first page
...
<SEO
  title={list_bitcoin_etfs_seo_title()}
  description={list_bitcoin_etfs_seo_description()}
  keywords={list_bitcoin_etfs_seo_keywords()}
  structuredData={{
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    name: list_index_bitcoin_etfs(),
    description: list_bitcoin_etfs_structured_description(),
    ...
    mainEntity: {
      "@type": "ItemList",
      name: list_bitcoin_etfs_main_name(),
      description: list_bitcoin_etfs_main_description(),
...
<section class="w-full overflow-hidden m-auto">
  <Infobox text={list_bitcoin_etfs_infobox()} />

  <div
    class="mt-6 mb-4 grid grid-cols-1 sm:grid-cols-3 overflow-hidden rounded-container border border-line bg-surface-card divide-y divide-gray-200/70 dark:divide-zinc-800/80 sm:divide-x sm:divide-y-0"
  >
  ...
  <div class="items-center lg:overflow-visible px-1 py-1 mt-4">
    ...
    >
      ...
      >
        ...
        <div class="ml-2">
          <DownloadData {data} {rawData} title="bitcoin_etfs_data" />
        </div>
  ...
  <div class="flex justify-center w-full m-auto h-full overflow-hidden">
    ...
    <div class="w-full mt-3">
      {#if displayList?.length > 0}
        ...
        />
      {:else}
        <Infobox text={list_bitcoin_etfs_empty({ query: inputValue ?? "" })} />
      {/if}
    </div>
  </div>
</section>
