...
<section class="w-full overflow-hidden m-auto">
  ...
  <div
    class="mt-5 mb-4 grid grid-cols-1 sm:grid-cols-3 overflow-hidden rounded-container border border-line bg-surface-card divide-y divide-gray-200/70 dark:divide-zinc-800/80 sm:divide-x sm:divide-y-0"
  >
