...
<section class="w-full overflow-hidden m-auto">
  ...
  <div class="sm:p-0 flex justify-center w-full m-auto overflow-hidden mt-5">
    ...
    >
      <main class="w-full">
        <div
          class="w-full flex flex-col sm:flex-row items-center justify-start sm:justify-between text-gray-700 dark:text-zinc-200 sm:pt-2 sm:pb-2 sm:border-t sm:border-b sm:border-gray-200 sm:dark:border-zinc-800/80"
        >
          <div
          ...
          >
            <div class="relative ml-auto w-full sm:min-w-56 sm:max-w-14">
              ...
              <input
                ...
                on:input={search}
                placeholder="Find..."
                class="py-2 text-[0.85rem] sm:text-sm border border-gray-300 shadow dark:border-zinc-800/80 rounded-full bg-white/80 dark:bg-zinc-950/60 text-gray-700 dark:text-zinc-200 placeholder:text-gray-500 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-0 focus:border-gray-300/80 dark:focus:border-zinc-700/80 grow w-full"
              />
            </div>
