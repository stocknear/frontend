    ...
    const options = {
      ...
      tooltip: {
        ...
        formatter: function () {
          ...
          let tooltipContent = `<span class="m-auto text-[1rem] font-[501]">Year ${yearValue}</span><br>`;
            ...
            >
              <div class="flex items-center gap-2">
                <Button
                  ...
                  class="w-fit transition-all flex flex-row items-center duration-50 border border-gray-300 dark:border-gray-700 text-white bg-black sm:hover:bg-default dark:bg-primary dark:sm:hover:bg-secondary sm:w-auto px-1.5 sm:px-3 rounded truncate disabled:opacity-60"
                >
                  <svg
