       ...
       {#if config}
        <div>
         <div class="grow">
          <div class="relative">
           <div
            class="mt-5 shadow-none sm:mt-0 sm:border sm:border-gray-200/70 dark:border-zinc-800/80 rounded"
       ...
       <div class="w-full overflow-x-auto">
        ...
        >
         <thead class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400">
          <tr>
           <th
            class="font-semibold text-start text-sm"
           >
           ...
           {#each categoryMetrics as metric}
            <th
             class="font-semibold text-end text-sm"
            >
             {metric.name}
            </th>
           {/each}
