    ...
    >
      <div class="sm:pl-7 sm:pb-7 w-full m-auto mt-2 sm:mt-0">
        {#if orderedCategories.length > 0}
                    ...
                    >
                      <div class="ml-auto">
                        <div class="inline-flex">
                          <div
                            class="w-fit flex text-sm items-center gap-1 rounded-full border border-gray-200/70 dark:border-zinc-800/80
           "
                          >
              ...
              >
                ...
                >
                  ...
                  >
                    <tr>
                      <th
                        class="border-b border-r border-gray-200/70 dark:border-zinc-800/80 font-semibold text-xs text-start"
                      >
                        Period Ending
                      </th>
                      {#each tableData.formattedDates as formattedDate (formattedDate)}
                        <th
                          class="z-20 border-b border-r min-w-[120px] border-gray-200/70 dark:border-zinc-800/80 font-semibold text-xs text-end"
                        >
                          {formattedDate}
                        </th>
                      {/each}
                  ...
                  >
                    {#each tableData.rows as row (row.name)}
                      <tr class="w-full transition-colors">
                        <th
                          class="whitespace-nowrap flex flex-row justify-between items-center text-sm font-normal text-start border-r border-gray-200/70 dark:border-zinc-800/80 text-gray-700 dark:text-zinc-200"
                        >
                          {row.name}
                          <label
                        ...
                        {#each row.cells as cell}
                          <td
                            class="whitespace-nowrap text-sm text-end border-b border-r border-gray-200/70 dark:border-zinc-800/80"
                          >
                      ...
                      <tr>
                        <td
                          class="min-w-auto md:min-w-96 w-full whitespace-nowrap flex flex-row justify-between items-center text-sm font-normal text-start border-r border-gray-200/70 dark:border-zinc-800/80"
                        >
                        ...
                        {#each row.cells as cell}
                          <td
                            class="text-sm text-end border-b border-r border-gray-200/70 dark:border-zinc-800/80 {cell.growthClass}"
                          >
          ...
          <div
            class="text-sm border border-gray-200/70 dark:border-zinc-800/80 p-3 -mt-5"
          >
...
<dialog id="financialPlotModal" class="modal px-3">
  ...
  <div
    class="metrics-modal modal-box w-full max-w-3xl p-6 rounded-2xl shadow-none border bg-white dark:bg-zinc-950 border border-gray-200/70 dark:border-zinc-800/80"
  >
    {#if config}
