        ...
        <div class="sm:pl-7 sm:pb-7 sm:pt-7 m-auto mt-2 sm:mt-0">
          ...
          {#if rawData?.length !== 0}
            <div class="grid grid-cols-1 gap-2">
              ...
              >
                <div
                  class="short-interest-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                ...
                <div
                  class="shortPriorMonth-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                    class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400"
                  >
                ...
                <div
                  class="changeMoM-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                    class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400"
                  >
                ...
                <div
                  class="shortPercentFloat-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                    class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400"
                  >
                ...
                <div
                  class="shortPercentOutstanding-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                    class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400"
                  >
                ...
                <div
                  class="daysToCover-driver rounded-2xl border border-gray-200/70 dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 p-4"
                >
                  <div
                    class="text-xs uppercase tracking-wide text-gray-500 dark:text-zinc-400"
                  >
