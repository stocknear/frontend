        ...
        <div class="sm:pl-7 sm:pb-7 sm:pt-7 m-auto mt-2 sm:mt-0">
          ...
          {#if rawData?.length !== 0}
            <div class="grid grid-cols-1 gap-2">
              ...
              >
                ...
                <div
                  class="category-driver shadow-none bg-white/70 dark:bg-zinc-950/40 border border-gray-300 shadow dark:border-zinc-800/80 rounded-2xl p-4"
                >
                  <div class=" text-sm mb-2 flex items-center">
                    <span>Category</span>
                  </div>
                ...
                <div
                  class="oneYearChange-driver shadow-none bg-white/70 dark:bg-zinc-950/40 border border-gray-300 shadow dark:border-zinc-800/80 rounded-2xl p-4"
                >
                  <div class=" text-sm mb-2 flex items-center">
              ...
              <div
                class="flex flex-col sm:flex-row items-start sm:items-center w-full border-t border-b border-gray-200 dark:border-zinc-800/80 py-2"
              >
              ...
              <div
                class="chart-driver border border-gray-300 shadow shadow-none dark:border-zinc-800/80 rounded-2xl bg-white/70 dark:bg-zinc-950/40"
                use:highcharts={config}
              ></div>

              <div
                class=" flex flex-row items-center w-full justify-between mt-2 border-t border-b border-gray-200 dark:border-zinc-800/80 py-2"
              >
          ...
          {activeIdx === i
              ...
              <div class="w-full overflow-x-auto">
                <table
                  class="table table-sm table-compact rounded-none sm:rounded w-full border border-gray-300 shadow dark:border-zinc-800/80 bg-white/70 dark:bg-zinc-950/40 text-gray-700 dark:text-zinc-200 tabular-nums m-auto mt-2"
                >
                  <thead>
