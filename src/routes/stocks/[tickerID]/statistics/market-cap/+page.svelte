        ...
        <div class="sm:pl-7 sm:pb-7 sm:pt-7 m-auto mt-2 sm:mt-0">
          ...
          {#if rawData?.length !== 0}
            <div class="grid grid-cols-1 gap-2">
              ...
              <div
                class="flex flex-col sm:flex-row items-start sm:items-center w-full border-t border-b border-gray-200/70 dark:border-zinc-800/80 py-2"
              >
              ...
              <div
                class=" flex flex-row items-center w-full justify-between mt-2 border-t border-b border-gray-200/70 dark:border-zinc-800/80 py-2"
              >
