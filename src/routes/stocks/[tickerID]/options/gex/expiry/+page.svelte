...
<SEO
  title={stock_detail_options_gex_expiry_seo_title({ company: $displayCompanyName, ticker: $stockTicker })}
  description={stock_detail_options_gex_expiry_seo_description({ company: $displayCompanyName, ticker: $stockTicker })}
  keywords={stock_detail_options_gex_expiry_seo_keywords({ ticker: $stockTicker })}
  type="website"
