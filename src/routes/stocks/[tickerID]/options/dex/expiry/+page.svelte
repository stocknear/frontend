...
<SEO
  title={stock_detail_options_dex_expiry_seo_title({ company: $displayCompanyName, ticker: $stockTicker })}
  description={stock_detail_options_dex_expiry_seo_description({ company: $displayCompanyName, ticker: $stockTicker })}
  keywords={stock_detail_options_dex_expiry_seo_keywords({ ticker: $stockTicker })}
  type="website"
  url={`https://stocknear.com/stocks/${$stockTicker}/options/dex/expiry`}
  structuredData={{
    "@context": "https://schema.org",
    "@type": ["FinancialProduct", "DataVisualization"],
    name: stock_detail_options_dex_expiry_structured_name({ company: $displayCompanyName }),
    description: stock_detail_options_dex_expiry_structured_desc({ company: $displayCompanyName, ticker: $stockTicker }),
    url: `https://stocknear.com/stocks/${$stockTicker}/options/dex/expiry`,
