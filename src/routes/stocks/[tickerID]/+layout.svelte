<script lang="ts">
  ...
  function shouldUseRealtimeSocket() {
    return Boolean(
      data?.wsURL && $isOpen && $stockTicker && !isComponentDestroyed,
    );
  }
  ...
  $: {
    if ($stockTicker && deLocalizeHref($page.url.pathname) === `/stocks/${$stockTicker}`) {
      displaySection = "overview";
    }
  }
              ...
              >
                ...
                <div class="pb-12 md:pb-20 w-full">
                  <div class="">
                        ...
                        >
                          ...
                          >
                            ...
                            <label
                              ...
                              class="flex-1 inline-flex items-center justify-center gap-1.5 cursor-pointer transition-all text-fg hover:text-accent px-2 py-2.5 text-xs font-medium"
                            >
                              <svg
                    ...
                    <nav
                      class=" sm:ml-4 border-b border-line overflow-x-auto whitespace-nowrap"
                    >
                      <ul
