  ...
  <div class="w-full max-w-[1600px] m-auto">
    <div class="flex flex-row items-center w-full xl:px-2">
        ...
        <div class="flex flex-row items-center cursor-pointer">
          ...
          <a href="/" class="flex flex-row items-center ml-2 sm:ml-4">
            <img class="w-8 sm:w-10 rounded-full" src={cloudFrontUrl+"/assets/stocknear_logo.png"}
              alt="stocknear logo" loading="lazy" />
            <div class="flex justify-center items-center text-xl font-medium mr-auto ml-2">
                <span class="self-center text-white font-bold whitespace-nowrap">stock</span>
                <span class="self-center text-[#FF3131] font-bold whitespace-nowrap">near</span>
            </div>
          </a>
