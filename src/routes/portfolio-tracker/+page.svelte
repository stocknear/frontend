...
<SEO
  ...
  structuredData={{
    ...
    description:
      "Real-time portfolio tracking with AI insights, predictive analytics, sentiment signals, and smart alerts for stocks and ETFs.",
    url: "https://stocknear.com/portfolio",
    applicationCategory: "FinanceApplication",
    applicationSubCategory: "PortfolioManagement",
    operatingSystem: "Web",
    ...
    audience: {
      "@type": "Audience",
      audienceType: "Individual investors and traders",
    },
    featureList: [
      "Real-time price tracking",
      "AI-driven insights and summaries",
      "Predictive analytics and risk signals",
      "News & social sentiment indicators",
      "Smart price and event-based alerts",
              ...
              {#key watchList}
                ...
                >
                  ...
                  <div class="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <div class="mt-1 flex items-baseline flex-wrap gap-3">
                        ...
                        <span
                          class="inline-flex items-center rounded-md bg-red-500/10 text-red-400 ring-1 ring-inset ring-red-500/20 px-2 py-1 text-sm font-medium"
                        >
                          -$1,452,654
                        </span>
                        <span
                  ...
                  <div class="mt-10">
                    ...
                    >
                      <!-- Large-cap 71.42% -->
                      <div class="bg-teal-400/90" style="width:71.42%"></div>
                      <!-- Small-cap 23.85% -->
                    ...
                    <div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
                      ...
                      <div class="flex items-center gap-2">
                        <span
                          class="inline-block size-3 rounded-full bg-amber-300"
                        ></span>
