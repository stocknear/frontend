...
<section class="w-full max-w-6xl m-auto pt-5 pb-60 min-h-screen overflow-hidden supports-[overflow:clip]:overflow-clip">
                            ...
                            <div class="md:grow pt-6 pb-12 w-full sm:mr-4 rounded-2xl sm:rounded-none">
                                <div class="sm:pr-5">
                                   ...
                                   {#if !data?.user}
                                    ...
                                    <a class="w-64 flex mb-5 justify-center items-center m-auto btn text-white bg-blue-700 hover:bg-blue-600 transition duration-150 ease-in-out group" href="/register">
                                        Get Started 
    ...
    .grid-background {
        background: linear-gradient(to bottom, #202020, #111011);
        width: 24rem;
        position: relative;
    }
