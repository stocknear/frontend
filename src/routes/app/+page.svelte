...
<div class="text-fg w-full">
  ...
  >
    <div
      class="mx-auto max-w-6xl px-6 py-16 sm:py-24 md:px-8 flex flex-col lg:flex-row items-center gap-12 lg:gap-16"
    >
      <div class="flex-1 text-center lg:text-left">
        <h1
          class="text-4xl font-semibold tracking-tight text-fg sm:text-5xl leading-tight"
        >
          {app_page_hero_title()}
        </h1>
        <p
          class="mt-6 max-w-xl text-lg leading-relaxed text-fg-muted mx-auto lg:mx-0"
        >
          {app_page_hero_description()}
        </p>
      </div>

      <div class="flex-shrink-0 hidden sm:inline-block">
        <img
          src="/img/mockup.png"
          alt="Stocknear app on mobile"
          class="h-full w-full sm:w-[600px]"
          loading="eager"
        />
      </div>
    </div>
  ...
  <section class="border-b border-line">
    <div class="mx-auto max-w-3xl px-6 py-16 sm:py-20 md:px-8">
      <h2
        class="text-3xl font-semibold tracking-tight text-fg text-center sm:text-4xl"
      >
        {app_page_install_title()}
      </h2>
      ...
      <div class="flex justify-center mt-8">
        <div
          class="inline-flex items-center gap-1 rounded-full border border-line p-1"
        >
          <button
            type="button"
          ...
          <ol class="space-y-4">
            <li class="flex items-start gap-4">
              <span
                ...
                >1</span
              >
              <span class="text-base text-fg-muted pt-1"
