<script lang="ts">
  ...
  const toolIcons: Record<string, string> = {
    ...
    // Utility icons
    magnet: "M14 10a2 2 0 0 0-2 2v11H6V12c0-4.416 3.584-8 8-8s8 3.584 8 8v11h-6V12a2 2 0 0 0-2-2zm-3 2a3 3 0 0 1 6 0v10h4V12c0-3.864-3.136-7-7-7s-7 3.136-7 7v10h4V12z M6.5 18h5v1h-5zm10 0h5v1h-5z",
    ...
    remove: "M18 7h5v1h-2.01l-1.33 14.64a1.5 1.5 0 0 1-1.5 1.36H9.84a1.5 1.5 0 0 1-1.49-1.36L7.01 8H5V7h5V6c0-1.1.9-2 2-2h4a2 2 0 0 1 2 2v1Zm-6-2a1 1 0 0 0-1 1v1h6V6a1 1 0 0 0-1-1h-4ZM8.02 8l1.32 14.54a.5.5 0 0 0 .5.46h8.33a.5.5 0 0 0 .5-.46L19.99 8H8.02Z",
  };
            ...
            <div class="relative mt-1 group/magnet">
              ...
              >
                <DropdownMenu.Group>
                  ...
                  >
                    <svg viewBox="0 0 28 28" class="h-[18px] w-[18px] flex-shrink-0 fill-current">
                      <path d={toolIcons.magnet}/>
                    </svg>
