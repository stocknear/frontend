            ...
            <div class="flex justify-center w-full max-w-5xl m-auto h-full overflow-hidden">
                ...
                <div class="w-full flex flex-row justify-center m-auto items-center pl-2 pr-2 sm:pl-0 sm:pr-0">
                    ...
                    <div class="w-full {index === selectedWeekday ? '' : 'hidden sm:block'}">
                            <label on:click={() => toggleDate(index)} class="w-11/12 sm:w-full m-auto  cursor-pointer h-16 {index === selectedWeekday ? 'bg-[#3C74D4] bg-opacity-[0.6] sm:bg-[#A24D51] sm:gradient-effect' : ''} rounded-lg sm:rounded-none flex bg-[#3C40F0] border border-blue-600 mb-3">
