...
$: {
  if($page.url.pathname)
  {
      ...
      <body class="bg-[#0F0F0F] pb-40">
          ...
          <!-- Page wrapper -->
          <div class="flex flex-col min-h-screen overflow-hidden m-auto w-full max-w-8xl mt-5 supports-[overflow:clip]:overflow-clip pb-40">
              <main class="grow">
                  <section>
                      <div class="w-full">
                                        ...
                                        <!--<div class="w-full max-w-3xl sm:max-w-2xl m-auto pt-2 pb-5 sm:pl-3 sticky z-20 bg-[#0F0F0F]"  style="top: {$screenWidth < 520 && $isScrollingUp ? '4rem' : '0rem'};">-->
                                          <div class="sm:ml-4 w-screen sm:w-full {$screenWidth < 640 ? 'overflow-auto scrollbar no-scrollbar' : ''} mb-2" >
                                            <ul class="pr-4 sm:pr-0 w-screen font-medium flex flex-row items-center bg-[#0F0F0F] overflow-x-scroll space-x-3 rtl:space-x-reverse py-2">
                                              ...
                                              <li class="cursor-pointer flex flex-col items-center">
                                                <a href={`/etf/${$etfTicker}/stats`} id="item2" on:click={() => (changeSection('stats','item2'))} class="px-2 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'stats' ? 'text-white ' : 'bg-[#0F0F0F]'}" >
                                                  Stats
                                                </a>
                                                <div class="{displaySection === 'stats' ? 'bg-[#75D377]' : 'bg-[#0F0F0F]'} mt-1 h-[3px] rounded-full w-[2rem]" />
                                              </li>
                                              <li class="cursor-pointer flex flex-col items-center">
                                                <a href={`/etf/${$etfTicker}/options`} id="item3" on:click={() => (changeSection('options','item3'))} class="px-2 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'options' ? 'text-white ' : 'bg-[#0F0F0F]'}" >
                                                  Options
                                                </a>
                                                <div class="{displaySection === 'options' ? 'bg-[#75D377]' : 'bg-[#0F0F0F]'} mt-1 h-[3px] rounded-full w-[3rem]" />
                                              </li>
                                              <li class="cursor-pointer flex flex-col items-center">
                                                <a href={`/etf/${$etfTicker}/holdings`} id="item4" on:click={() => (changeSection('holdings','item4'))} class="px-2 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'holdings' ? 'text-white ' : 'bg-[#0F0F0F]'}" >
                                                  Holdings
                                                </a>
                                                <div class="{displaySection === 'holdings' ? 'bg-[#75D377]' : 'bg-[#0F0F0F]'} mt-1 h-[3px] rounded-full w-[3rem]" />
                                              </li>
                                              <li class="cursor-pointer flex flex-col items-center">
                                                <a href={`/etf/${$etfTicker}/dividends`} id="item5" on:click={() => (changeSection('dividends','item5'))} class="px-2 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'dividends' ? 'text-white ' : 'bg-[#0F0F0F]'}" >
                                                  Dividends
                                                </a>
                                                <div class="{displaySection === 'dividends' ? 'bg-[#75D377]' : 'bg-[#0F0F0F]'} mt-1 h-[3px] rounded-full w-[3rem]" />
                                              </li>
                                              <li class="cursor-pointer flex flex-col items-center">
                                                <a href={`/etf/${$etfTicker}/congress-trading`} id="item5" on:click={() => (changeSection('congress-trading','item5'))} class="px-2 text-sm sm:text-[0.9rem] font-medium text-gray-400 sm:hover:text-white {displaySection === 'congress-trading' ? 'text-white ' : 'bg-[#0F0F0F]'}" >
                                                  Insider
                                                </a>
