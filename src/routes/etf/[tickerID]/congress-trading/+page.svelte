            ...
            <div class="relative flex justify-center items-center overflow-hidden">
                  <div class="sm:p-7 sm:w-full sm:max-w-3xl m-auto mt-5 sm:mt-0">
                    <div class="mb-6">
                      ...
                      <label on:click={changeStructure} class="sm:hidden w-24 sm:ml-3 mr-2 sm:mr-0 cursor-pointer bg-[#18181B] sm:hover:bg-[#202020] duration-100 transition ease-in-out px-4 py-2 rounded-lg shadow-md">
