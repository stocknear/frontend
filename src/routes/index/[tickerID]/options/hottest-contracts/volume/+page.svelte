...
<SEO
  title={`${$displayCompanyName} (${$indexTicker}) Highest Options Volume Contracts`}
  description={`Track the highest-volume contracts for ${$displayCompanyName} (${$indexTicker}) to spot concentrated flow.`}
/>
