        ...
        <div class="w-full sm:-mt-6 mb-8 m-auto flex justify-center items-center p-3">
          ...
          <MiniPlot title="Russel 2000" priceData = {priceDataRussel2000} changesPercentage={changeRussel2000} previousClose={previousCloseRussel2000}/>
            ...
            <div class="flex flex-col justify-center items-center m-auto pt-8">
                ...
                {#if !data?.user}
                <a class="w-64 flex mt-10 justify-center items-center m-auto btn text-white bg-blue-700 hover:bg-blue-600 transition duration-150 ease-in-out group" href="/register">
                    Get Started 
            ...
            <div class="w-screen sm:w-full rounded-lg overflow-hidden overflow-x-scroll no-scrollbar">
                <table class="table table-sm table-compact rounded-none sm:rounded-md w-full bg-[#0F0F0F] border-bg-[#0F0F0F] m-auto mt-4 ">
                  ...
                  <tbody class="p-3">
                    ...
                    <!-- row -->
                    <tr on:click={() => stockSelector(item?.symbol, item?.assetType)} class="sm:hover:bg-[#245073] sm:hover:bg-opacity-[0.2] {index % 2 === 0 ? 'bg-opacity-[0.25] bg-[#323239]' : 'bg-[#0F0F0F]'} border-b-[#0F0F0F] cursor-pointer">
