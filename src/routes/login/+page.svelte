  ...
  <!-- Add more Twitter meta tags as needed -->
	...
	<div class="w-full max-w-3xl min-h-screen m-auto pb-40 sm:mt-10">
			...
			<div class="grid grid-cols-1 gap-4" >
				...
				<form method="post" action="?/oauth2" class="flex flex-col items-center w-5/6 pt-4 ml-auto mr-auto">
					<div class="w-3/4 sm:w-1/2 max-w-lg  m-auto ">
						...
						<button 
							...
							class="py-3 flex flex-row items-center justify-center bg-[#27272A] border border-gray-600 text-white sm:hover:bg-[#313131] w-full rounded-lg" type="submit">
				...
				<form method="post" action="?/oauth2" class="flex flex-col items-center mb-5 w-5/6 ml-auto mr-auto">
					<div class="w-3/4 sm:w-1/2 max-w-lg m-auto">
						...
						<button 
							...
							class="py-3 flex flex-row items-center justify-center bg-[#27272A] border border-gray-600 sm:hover:bg-[#313131] text-white w-full rounded-lg" type="submit">
				...
				<span class="text-white text-lg text-center m-auto font-medium mb-5">
				...
				<div class="relative w-full max-w-lg m-auto">
					...
					<form action="?/login" method="POST" use:enhance={submitLogin} class="flex flex-col items-center space-y-2 pt-4 pl-3 pr-3 sm:pl-0 sm:pr-0 ml-auto mr-auto">
						...
						<p class="pb-1 text-sm w-full max-w-lg text-white flex justify-center items-center">You don't have an account?
							<a href="/register" class="text-blue-400 hover:underline ml-1">Sign up</a>
						</p>
