			...
			<form method="post" action="?/oauth2" class="flex flex-col items-center w-5/6 pt-4 ml-auto mr-auto">
				<div class="w-3/4 sm:w-1/2 max-w-lg  m-auto ">
					...
					<button 
						...
						class="py-3 flex flex-row items-center justify-center text-white bg-[#27272A] border border-gray-600 sm:hover:bg-[#313131] w-full rounded-lg" type="submit">
			...
			<form method="post" action="?/oauth2" class="flex flex-col items-center mb-5 w-5/6 ml-auto mr-auto">
				<div class="w-3/4 sm:w-1/2 max-w-lg m-auto">
					...
					<button 
						...
						class="py-3 flex flex-row items-center justify-center bg-[#27272A] border border-gray-600 sm:hover:bg-[#313131] text-white w-full rounded-lg mt-5" type="submit">
