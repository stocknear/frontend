...
<section class="bg-[#0A0A0A] w-full max-w-screen {data?.user ? 'hidden' : ''}">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="flex flex-col sm:flex-row items-center mt-10 mx-auto justify-center">
          ...
          <a href="/register" style="font-weight: 600" class="w-fit flex flex-row items-center m-auto px-6 py-3 bg-[#9DED1E] text-black text-[1rem] sm:text-lg rounded-full transition duration-150 ease-in-out group">
