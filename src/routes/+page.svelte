                                ...
                                -->
                                  ...
                                  <span class="text-center flex-1 justify-center items-center text-white text-[1rem] sm:text-lg">
                                    ...
                                    <div class="flex flex-col gap-y-4 justify-center items-center mt-8 mb-6 m-auto w-full max-w-3xl">
                                      <a href="/register" style="font-weight: 600" class="flex flex-row items-center px-6 py-3 bg-[#FBCE3C] text-black text-[1rem] sm:text-lg rounded-full transition duration-150 ease-in-out group">
                                      ...
                                      <span class="text-white text-sm sm:text-lg">
                                        <svg class="w-5 h-5 inline-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="none" stroke="#FBCE3C" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M416 128L192 384l-96-96"/></svg>
...
<section class="bg-[#0A0A0A] w-full max-w-screen {data?.user ? 'hidden' : ''}">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="flex flex-col sm:flex-row items-center mt-10 mx-auto justify-center">
          ...
          <a href="/register" style="font-weight: 600" class="w-fit flex flex-row items-center m-auto px-6 py-3 bg-[#FBCE3C] text-black text-[1rem] sm:text-lg rounded-full transition duration-150 ease-in-out group">
