            ...
            <div class="">
              ...
              <div class="mb-10">
                <Button
                  ...
                  class="flex-shrink-0 w-fit border border-line bg-gray-900 hover:bg-gray-800 text-white dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 ease-out flex flex-row justify-between items-center px-4 py-2 rounded-full truncate"
                >
                  {privacy_cookies_button()}
                </Button>
              </div>
