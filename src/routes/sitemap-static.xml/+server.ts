...
const pages = [
  ...
  { path: "/list/safe-dividend-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/high-free-cash-flow-yield-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/undervalued-growth-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/low-pe-high-roe-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/strong-balance-sheet-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/piotroski-8-9-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/net-cash-stocks", priority: 0.65, changefreq: "daily" },
  { path: "/list/earnings-growth-stocks-this-month", priority: 0.65, changefreq: "daily" },
  { path: "/list/high-analyst-upside-stocks", priority: 0.65, changefreq: "daily" },
