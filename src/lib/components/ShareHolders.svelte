  ...
  <main class="overflow-hidden">
    {#if shareholderList?.length !== 0}
      ...
      >
        ...
        <div
          class="border border-gray-300 shadow dark:border-zinc-800/80 rounded-2xl bg-white/70 dark:bg-zinc-950/40 w-full mt-4"
      ...
      {#if putCallRatio !== 0}
        ...
        <div class="w-full mt-5 mb-10 m-auto flex justify-center items-center">
          ...
          >
            <!--Start Put/Call-->
            <div
              class="flex flex-row items-center flex-wrap w-full px-3 sm:px-5 border border-gray-300 shadow dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/60 rounded-2xl h-20"
            >
