                        ...
                        <div class="flex flex-row items-center gap-x-5 pb-6">
							<form method="post" action="?/oauth2">
								...
								<button
									...
									class="cursor-pointer flex-shrink-0 rounded-full w-12 h-12 relative bg-[#27272A] flex items-center justify-center border border-gray-600 sm:hover:bg-[#313131] text-white">
