...
>
  ...
  <div
    class="z-999 modal-box min-h-96 overflow-hidden rounded-xl border border-gray-300 shadow dark:border-zinc-700 bg-white/95 dark:bg-zinc-950/90 shadow-none m-auto sm:my-8 sm:h-auto w-full sm:w-3/4 lg:w-1/2 2xl:w-1/3"
  >
    <label
      for="searchBarModal"
