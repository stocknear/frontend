...
<div class="w-full">
  ...
  {:else if showSummary}
    <!-- AI Summary Panel -->
    <div
      class="border border-gray-300 shadow dark:border-zinc-800/80 rounded-2xl p-4 sm:p-6 bg-white/70 dark:bg-zinc-950/40 text-gray-700 dark:text-zinc-200"
    >
      {#if isGeneratingSummary}
        <!-- Loading State -->
      ...
      {:else}
        ...
        <div class="space-y-6">
          ...
          >
            <div class="flex items-center gap-2">
              <button
                ...
                class="cursor-pointer flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-full border border-gray-300 shadow dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-950/60 text-gray-700 dark:text-zinc-200 transition hover:text-violet-600 dark:hover:text-violet-400"
              >
                <svg
                  class="w-3.5 h-3.5"
                  fill="none"
          ...
          <div>
            ...
            <p
              class="text-sm text-gray-700 dark:text-zinc-200 bg-white/70 dark:bg-zinc-950/40 rounded-2xl p-4 border border-gray-300 shadow dark:border-zinc-800/80"
            >
