...
<div class="flex flex-row items-center m-auto justify-center gap-x-3 pb-6">
  ...
  <form method="post" {action}>
    ...
    <button
      ...
      class="cursor-pointer shrink-0 rounded-full w-11 h-11 relative bg-[#f8fbfb] dark:bg-zinc-900/50 flex items-center justify-center border border-gray-300 shadow dark:border-zinc-700 hover:bg-gray-50 dark:hover:bg-zinc-900/80 transition text-muted dark:text-white"
    >
      <svg
