...
{#if data?.user}
  <a
    href="/notifications"
    on:click={toggle}
    class="relative flex-shrink-0 inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 shadow dark:border-zinc-700 bg-white/70 dark:bg-zinc-900/50 text-fg transition hover:bg-white dark:hover:bg-zinc-900/70 hover:text-accent"
  >
