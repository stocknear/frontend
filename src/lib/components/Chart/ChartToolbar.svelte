        ...
        {#if !drawingsLocked}
          <DropdownMenu.Trigger asChild let:builder>
            ...
            >
              <svg
                viewBox="0 0 4 6"
                class="w-[6px] h-[9px] fill-gray-600 dark:fill-zinc-300 transition-transform duration-300 ease-out {dropdownStates[
                  group.id
                ]
                  ? 'rotate-90'
                  : ''}"
    ...
    <div class="relative mt-1 group/magnet">
      ...
      <DropdownMenu.Trigger asChild let:builder>
        ...
        >
          <svg
            viewBox="0 0 4 6"
            class="w-[6px] h-[9px] fill-gray-600 dark:fill-zinc-300 transition-transform duration-300 ease-out {dropdownStates.magnet
              ? 'rotate-90'
              : ''}"
          >
            <path
