...
<a href="/pricing" class="mt-10 flex justify-center items-center w-56 m-auto btn text-white bg-blue-700 hover:bg-blue-600 transition duration-150 ease-in-out group">
    Become a Pro
