...
<label for="{$screenWidth > 640 ? 'marketHour' : ''}" class="cursor-pointer">
  {#if $isOpen}
  <div class="sm:border sm:border-slate-800 bg-[#202020] sm:hover:bg-[#333333] sm:ease-in-out sm:duration-100 rounded-2xl pl-3 pr-3 pt-1 pb-1 flex flex-row items-center">
  ...
  <div class="sm:border sm:border-slate-800 bg-[#202020] sm:hover:bg-[#333333] sm:ease-in-out sm:duration-100 rounded-2xl pl-3 pr-3 pt-1 pb-1 flex flex-row items-center">
    ...
    <span class="relative flex h-1.5 w-1.5 sm:h-2 sm:w-2 ml-2">
      <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#FF2F1F] opacity-75"></span>
      <span class="relative inline-flex rounded-full h-1.5 w-1.5 sm:h-2 sm:w-2 bg-[#FF2F1F]"></span>
    </span>
  </div>
  {/if}
</label>
...
<Drawer.Root>
  ...
  <Drawer.Trigger>
      <label for="extendedHoursInfo" class="ml-2 shadow-lg cursor-pointer rounded-full w-7 h-7 relative sm:border sm:border-slate-800 bg-[#202020] sm:hover:bg-[#333333] flex items-center justify-center border border-slate-800">
    ...
    <Drawer.Portal>
      ...
      <Drawer.Content class="fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] bg-[#202020]">
        <div class="flex-1 rounded-t-[10px] bg-[#202020] p-4">
...
<label for="marketHour" class="modal modal-bottom sm:modal-middle cursor-pointer">
  ...
  <label class="modal-box w-full relative bg-[#202020] h-auto">
    <label for="marketHour" class="cursor-pointer absolute right-5 top-2 bg-[#202020] text-2xl text-white">
      ✕
    </label>
    ...
    Its trading hours are from <span class="text-white font-semibold underline">9:30</span> ET in the morning to <span class="text-white font-semibold underline">16:00</span> ET in the afternoon.
    ...
    <table class="table table-sm table-compact bg-[#202020] w-full mt-5 mb-10 text-white">
      ...
      <tbody>
        <!-- row 1 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold "> New Years Day</td>
          <td class="bg-[#202020] ">01.01.2024</td>
        </tr>
        <!-- row 2 -->
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Martin Luther King, Jr. Day</td>
          <td class="bg-[#202020] ">15.01.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Washington's Birthday</td>
          <td class="bg-[#202020] ">19.02.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">
            Good Friday
            </td>
          <td class="bg-[#202020]">29.03.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Memorial Day</td>
          <td class="bg-[#202020] ">27.05.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Juneteenth National Independence Day</td>
          <td class="bg-[#202020] ">19.06.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Independence Day</td>
          <td class="bg-[#202020] ">04.07.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Labor Day</td>
          <td class="bg-[#202020] ">02.09.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Thanksgiving Day</td>
          <td class="bg-[#202020] ">28.11.2024</td>
        </tr>
        <tr class="border-b border-slate-700">
          <td class="bg-[#202020] font-semibold ">Christmas</td>
          <td class="bg-[#202020] ">25.12.2024</td>
        </tr>
      </tbody>
    </table>
