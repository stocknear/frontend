            ...
            <tbody>
                {#each wiim as item}
                    <tr class="border-b border-line"
                        ><td
                            class="hidden sm:inline-block pr-2 pt-4 align-top text-xs whitespace-nowrap font-semibold uppercase tracking-wide text-fg-muted"
                            >{formatDate(item?.date, true)}
                        </td>
                        <td
                            class="py-3 sm:pl-2 leading-6 text-fg"
                        >
                            <span
                                class="sm:hidden text-xs uppercase tracking-wide text-fg-muted font-semibold"
                                >{dashboard_time_ago({
