...
<div class="w-full max-w-xl m-auto mb-10">
  <div
    class="relative p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-gray-100 to-white dark:from-zinc-900 dark:to-black border border-gray-200 dark:border-zinc-700/50 shadow-xl dark:shadow-2xl overflow-hidden"
  >
    <!-- Subtle glow effect -->
    <div
      class="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-violet-500 to-transparent"
    ></div>
    ...
    <div class="relative z-10">
      ...
      <div class="flex justify-center mb-8">
        ...
        >
          <span
            class="text-gray-400 dark:text-zinc-500 text-sm uppercase tracking-wide"
            >Code</span
          >
          <span
      ...
      {#if copied}
        <p
          class="text-center text-emerald-500 dark:text-emerald-400 text-xs -mt-6 mb-6 font-medium"
        >
          Copied
        </p>
      {/if}
      ...
      <div class="border-t border-gray-200 dark:border-zinc-700/50 pt-6">
        <p
          class="text-center text-gray-400 dark:text-zinc-500 text-xs font-medium tracking-widest uppercase mb-4"
        >
          Ends in
        </p>
        <div class="grid grid-cols-4 gap-2 sm:gap-4 max-w-sm mx-auto">
          <div class="text-center">
            <div
              class="bg-gray-100 dark:bg-zinc-800/80 rounded-lg px-2 sm:px-4 py-3"
            >
              <span
                class="countdown font-mono text-xl sm:text-2xl font-bold text-gray-900 dark:text-white"
              >
                <span style="--value:{days};"></span>
              </span>
            </div>
            <span
              class="text-[10px] text-gray-400 dark:text-zinc-500 uppercase tracking-wider mt-2 block"
              >Days</span
            >
          </div>
          <div class="text-center">
