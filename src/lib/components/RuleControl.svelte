...
<div class="w-full max-w-xl text-white  text-sm sm:text-[1rem] flex flex-row justify-center items-center">
  ...
  <label on:click={() => changeRuleCondition('under')} class="ml-5 cursor-pointer flex flex-row mr-2 justify-center items-center">
    <input type="radio" class="radio checked:bg-[#fff] bg-default border border-line mr-2" 
...
>
  ...
  <div class="flex items-center">
    <button
      class="mr-1.5 cursor-pointer text-fg-muted sm:hover:text-red-500 focus:outline-hidden"
      title="Remove filter"
    >
      <svg
        class="w-5 h-5"
    ...
    <div class="relative inline-block text-left">
      <div class="dropdown dropdown-end">
        <button
          tabindex="0"
          class="bg-[#000] h-[33px] flex flex-row justify-between items-center w-[150px] xs:w-[140px] sm:w-[150px] px-3 text-white rounded-control truncate"
        >
        ...
        <div
          class="dropdown-content absolute z-40 mt-2 rounded-control bg-[#181C1F] py-1 shadow-lg border border-line focus:outline-hidden"
          tabindex="0"
          role="menu"
        >
            ...
            <div class="flex items-center justify-start gap-x-1">
              ...
              >
                ...
                >
                  <input
                    type="radio"
                    class="radio checked:bg-[#fff] bg-default border border-line mr-2"
          ...
          <div
            class="thin-scrollbar dark:styled-scrollbar dark:right-scrollbar max-h-[250px] overflow-y-auto overflow-x-hidden overscroll-contain border-t border-line
                dark:border-dark-500 xl:max-h-[297px]"
          >
            {#each step as newValue}
              <button
                on:click={() => changeValue(newValue)}
                class="block w-full border-b border-line px-4 py-2 text-left text-sm text-white last:border-0 sm:hover:bg-gray-100 sm:hover:text-gray-900
