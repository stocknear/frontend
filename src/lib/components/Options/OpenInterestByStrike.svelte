  ...
  <div class="mt-7 flex flex-wrap items-center justify-between gap-3">
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Content
        ...
        sideOffset={10}
        alignOffset={0}
        class="min-w-56 w-auto max-w-64 max-h-[400px] overflow-y-auto scroller relative rounded-container border border-line bg-surface-card p-2 text-fg shadow-none"
      >
