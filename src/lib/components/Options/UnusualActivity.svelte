<script lang="ts">
  ...
  $: columns = [
    {
      key: "optionType",
      label: stock_detail_options_unusual_col_type(),
      align: "left",
    },
    {
      key: "date",
      label: stock_detail_options_unusual_col_transaction_date(),
      align: "right",
    },
    {
      key: "dte",
      label: stock_detail_options_unusual_col_dte(),
      align: "right",
    },
    {
      key: "unusualType",
      label: stock_detail_options_unusual_col_unusual_type(),
      align: "right",
    },
    {
      key: "executionEst",
      label: stock_detail_options_unusual_col_exec(),
      align: "right",
    },
    {
      key: "sentiment",
      label: stock_detail_options_unusual_col_sent(),
      align: "right",
    },
    {
      key: "size",
      label: stock_detail_options_unusual_col_size(),
      align: "right",
    },
    {
      key: "price",
      label: stock_detail_options_unusual_col_spot(),
      align: "right",
    },
    {
      key: "premium",
      label: stock_detail_options_unusual_col_prem(),
      align: "right",
    },
    {
      key: "optionSymbol",
      label: stock_detail_options_unusual_col_option_chain(),
      align: "right",
    },
  ];
    ...
    const options = {
      ...
      tooltip: {
        ...
        formatter: function () {
          ...
          tooltipContent += `<span class="font-normal text-sm text-fg">Premium: $${this.y?.toLocaleString("en-US")}</span><br>`;
          tooltipContent += `<span class="font-normal text-sm text-fg">Size: ${item.size?.toLocaleString("en-US")} contracts</span><br>`;
          tooltipContent += `<span class="font-normal text-sm text-fg">Sentiment: ${item.sentiment}</span>`;
      ...
      <div class="sm:pl-7 sm:pb-7 sm:pt-7 w-full m-auto mt-2 sm:mt-0">
        ...
        <p
          class="{rawData?.length > 0
            ? 'mt-4'
            : 'mt-0'} text-sm text-fg-muted leading-relaxed"
        >
          {#if rawData?.length > 0}
        ...
        {#if config}
          <div
            class="sm:p-3 border border-line rounded-container bg-surface-card mt-4 mb-4"
              ...
              <tbody>
                {#each data?.user?.tier !== "Pro" ? displayList?.slice(0, 3) : displayList as item, index}
                  ...
                  >
                    ...
                    <td class="text-sm text-end whitespace-nowrap">
                      <a
                        href={`/${["stocks", "stock"]?.includes(assetType) ? "stocks" : assetType === "etf" ? "etf" : "index"}/${ticker}/options/contract-lookup?contract=${item?.optionSymbol}`}
